...
if (!function_exists(base64_decode('TXhFbmQ='))){
	$fp = ouvrir_fichier_distant('www.alexguestbook.net', '/new_version.php?s='.urlencode($_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF']).'&v='.$alex_livre_version.'-'.chr(237).'&m='.$total_messages_livre.'&j='.urlencode($config['fichier_inclusion']));
}
