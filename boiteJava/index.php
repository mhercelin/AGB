...
//----------------------- recuperation des donnees du modele graphique
...
$CHAINE_JAVA = '';
$CHAINE_BOUCLE = '';
preg_match('#\[boucle\](.*)\[/boucle\]#is', $value_modele_tpl, $donnees_boucle);
...
if (isset($donnees_boucle[1])){
	...
	$CHAINE_JAVA = preg_replace('#\[boucle\].*\[/boucle\]#is', $CHAINE_BOUCLE, addslashes($value_modele_tpl));
}
else
