...
$f_lang['user_base'] = "U¾ivatelské jméno";
...
$f_lang['name_table_users'] = "Tabulka u¾ivatelù";
...
$f_lang['choose_extension'] = "Vyberte pøíponu pro skripty<br>(doporuèujeme \"php\", jinak budete muset pøejmenovat v¹echny soubory na vámi zvolenou pøíponu)";
$f_lang['identi_acces_admin'] = "Va¹e pøihla¹ovací údaje do administrátorského panelu";
$f_lang['login_admin'] = "U¾ivatelské jméno";
$f_lang['pass_admin'] = "Heslo";
$f_lang['verif_pass_admin'] = "Zopakujte heslo";
$f_lang['email_admin_setup'] = "Vá¹ email";
$f_lang['installer'] = "Instalovat";
$f_lang['erreur_host'] = "Není vyplnìn údaj o databázovém serveru";
$f_lang['erreur_user'] = "Není vyplnìno u¾ivatelské jméno k databázi";
$f_lang['erreur_nom_base'] = "Není vyplnìno jméno databáze";
$f_lang['erreur_log_admin'] = "Není vyplnìno Va¹e u¾ivatelské jméno pro pøístup do administrátorského rozhraní";
$f_lang['erreur_pass_admin'] = "Není vyplnìno Va¹e heslo pro pøístup do administrátorského rozhraní";
$f_lang['erreur_pass_differents'] = "POZOR, zadaná hesla nejsou shodná.";
$f_lang['erreur_first_connexion'] = "<b>CHYBA, nezdaøilo se pøipojení k databázi.</b><br><br>zkontrolujte prosím pøihla¹ovací údaje : <a href=\"javascript:history.go(-1);\"><b>zpìt</b></a>.";
$f_lang['erreur_install'] = "Instalace se nezdaøila.";
$f_lang['ok_install'] = "Instalace byla úspì¹ná";
$f_lang['text_ok_install'] = "<b>Díky ! Instalace byla úspì¹ná.</b><br><br>Z bezpeènostních dùvodù dùraznì doporuèujeme smazat instalaèní právì pou¾itý skript (\"setup.php\"), pokud tak neuèiníte, kdokoliv jej mù¾e pou¾ít k modifikaci/znièení va¹ich konfiguraèních souborù.<br><br>Nyní mù¾ete spravovat  Va¹i náv¹tìvní knihu kliknutím <a href=\"".$chem_absolu."admin/\" target=\"_blank0\"><b>zde</b></a> nebo<br> ji shlédnout pohledem náv¹tìvníka <a href=\"".$chem_absolu."\" target=\"_blank1\"><b>zde</b></a>. Odkazy se otevírají v novém oknì.";

/* administration */
$f_lang['page protect'] = "Chránìná stránka";
$f_lang['login'] = "U¾iv.jméno";
$f_lang['pass'] = "Heslo";
...
$f_lang['graphismes'] = "Vzhled náv¹.knihy";
...
$f_lang['donner_avis'] = "Vá¹ názor";
$f_lang['deconnexion'] = "odhlásit";

 /* options */
 $f_lang['options_livre'] = "Mo¾nosti náv¹tìvní knihy";
$f_lang['options_generales'] = "Souhrnné parametry";
$f_lang['langue'] = "Jazyk";
$f_lang['send_mail'] = "Chcete, aby administrátor e-mailem obdr¾el novì vlo¾ené zprávy ?";
$f_lang['avert_mail'] = "<br>(<b>pozor</b> : funkce mail() na va¹em serveru je vypnuta, tak¾e ani pøi za¹krtnuté volbì \"ano\" nemù¾ete dostávat e-mailová upozornìní)";
$f_lang['oui'] = "ano";
$f_lang['non'] = "ne";
$f_lang['options_modules'] = "Jednotlivá pole náv¹tìvní knihy";
$f_lang['admin_champ_email'] = "Náv¹tìvník mù¾e zadat e-mailovou adresu";
$f_lang['admin_champ_site'] = "Náv¹tìvník mù¾e zadat adresu jeho www stránek";
$f_lang['admin_champ_pays'] = "Náv¹tìvník mù¾e zadat mìsto a zemi";
$f_lang['admin_champ_note'] = "Náv¹tìvník mù¾e hodnotit va¹e stránky";
$f_lang['admin_ok_aff_moteur'] = "Zpøístupnit vyhledávaèùm";
$f_lang['options_tech'] = "Technické parametry";
$f_lang['url_recharger'] = "Stránka pro aktualizace náv¹tìvní knihy";
$f_lang['url_variables'] = "Promìnná pou¾ívaná jako parametr (zadejte # místo $ v názvu promìnné)";
$f_lang['temps_session'] = "Doba platnosti session pro administrátorské rozhraní (v sekundách)";
$f_lang['skin_to_use'] = "Pou¾ít vzhled";
$f_lang['enregistrer'] = "Ulo¾it";
$f_lang['nb_pages'] = "Poèet zpráv zobrazených na jedné stránce náv¹t.knihy";
$f_lang['merci_options'] = "Díky, parametry byly aktualizovány";
$f_lang['erreur_options'] = "CHYBA\\nParametry se nepodaøilo ulo¾it, nebylo mo¾no zapisovat do souboru \\\"config.".$alex_livre_ext."\\\", pro zmìnu nastavení editujte tento soubor pomocí textového editoru.";
$f_lang['temps_ip_post'] = "Poèet minut, po kterých mù¾e náv¹tìvník vlo¾it dal¹í zprávu";
$f_lang['minutes'] = "minut";
$f_lang['cut_mots'] = "Max.délka slova - del¹í slova budou rozdìlena";
$f_lang['format_date'] = "Formát data";

/* skins */
$f_lang['ok_ajouter'] = "Díky, vzhled byl úspì¹nì vytvoøen";
$f_lang['erreur_ajouter'] = "CHYBA\\nVzhled se nepodaøilo vytvoøit, vytvoøte jej ruènì";
$f_lang['text1_2'] = "Vzhled byl ulo¾en do slo¾ky &quot;templates/skins/&quot;. Toto rozhraní vám umo¾òuje jej jednodu¹e mìnit, ale mù¾ete tak èinit i ruènì editací html souborù.";
$f_lang['text2'] = "<b>Pokud chcete také zmìnit vhled masky administrátorského rozhraní</b> modifikujte prosím ruènì soubory ve slo¾ce &quot;templates/admin/&quot;.";
...
$f_lang['pages_dispos'] = "sekce: seznam stránek / dal¹í strana - pøedchozí strana";
...
$f_lang['erreur_edit_skin'] = "CHYBA\\nJeden nebo více souborù vzhledu nebylo mo¾no aktualizovat. Upravte prosím tyto soubory ruènì.";
$f_lang['ajouter'] = "Pøidat";
...
$f_lang['erreur_aj_censure2'] = "Zadejte prosím slovo, které má být pou¾ito jako náhrada";
$f_lang['ok_aj_mot'] = "Díky, zakázané slovo bylo pøidáno.";
$f_lang['verif_sup'] = "Chcete opravdu definitivnì smazat vybraná slova ?";
$f_lang['merci_modif'] = "Díky, zmìny byly ulo¾eny";

/* bannir des ip */
$f_lang['bannir_ip'] = "Zakázané IP";
$f_lang['text_ip1'] = "Ka¾dý náv¹tìvník má pøidìlenu specifickou èíselnou IP adresu (napø. 201.10.25.14). Tato adrese je pøidìlována poskytovatelem internetu pøi pøipojení a mìní se, teoreticky, kdykoliv se náv¹tìvník znovu pøipojí k internetu.";
$f_lang['text_ip2'] = "Pokud chcete <b>zakázat náv¹tìvníkovi vkládat zprávu do va¹í náv¹tìvní knihy</b>, mù¾ete sem zadat jeho IP adreseu. Mù¾ete také zakázat rozsah IP adres pou¾itím zástupného symbolu * (napø. 201.15.55.*, nebo tøeba 158.*.*.*).";
...
$f_lang['text_smileys'] = "<b>Smajlíci dovolují vyjádøit náv¹tìvníkovi jeho emoce</b> pøi zápisu. V tomto rozhraní mù¾ete jednodu¹e pøidávat èi mazat smajlíky tak, aby mìl náv¹tìvník z èeho vybírat :o)<br><br>Smajlíci z této stránky jsou ulo¾eny ve slo¾ce \"images/smileys\".";
...
$f_lang['ok_aj_smiley'] = "Díky, smajlík byl úspì¹nì pøidán";
$f_lang['no_smiley'] = "Smajlíci mohou být pouze ve formátu GIF nebo JPEG";
$f_lang['copy_impossible'] = "CHYBA\\nSmajlíka se nepodaøilo nahrát do slo¾ky \\\"images/smileys\\\".";
$f_lang['car_replace_exist'] = "CHYBA\\nTento kód ji¾ v databázi existuje.";
$f_lang['modif_smileys'] = "Aktualizovat v¹echny smajlíky";
...
if (!(isset($_GET['id_modif']) && $_GET['id_modif'])){
	$f_lang['add_admin_texte'] = "Pøidat administrátora náv¹tìvní knihy";
	$f_lang['add_admin_2'] = "Pøidat administrátora";
	$f_lang['ajouter_admin'] = "Pøidat";
	$f_lang['name_ajouter_admin'] = "pøidat";
}
else{
	$f_lang['add_admin_texte'] = "Úprava administrátora náv¹t.knihy";
	$f_lang['add_admin_2'] = "Upravit administrátora";
	$f_lang['ajouter_admin'] = "Ulo¾it";
	$f_lang['name_ajouter_admin'] = "upravit";
}

$f_lang['identif_connexion'] = "Pøihla¹ovací jméno";
$f_lang['passe_admin'] = "Heslo";
$f_lang['email_admin'] = "E-mail (dùle¾ité v pøípadì, kdy admin má dostávat e-maily po vlo¾ení zprávy)";
$f_lang['admin_receive_email'] = "Chcete, aby admin dostábval e-mail po ka¾dé vlo¾ené zprávì ?";
$f_lang['admin_modif_options'] = "&nbsp;&nbsp;&nbsp;&nbsp;\"&nbsp;&nbsp;&nbsp;&nbsp;mù¾e mìnit parametry skriptù ?";
$f_lang['admin_gestion_skins'] = "&nbsp;&nbsp;&nbsp;&nbsp;\"&nbsp;&nbsp;&nbsp;&nbsp;mù¾e mìnit vzhled ?";
$f_lang['admin_gestion_messages'] = "&nbsp;&nbsp;&nbsp;&nbsp;\"&nbsp;&nbsp;&nbsp;&nbsp;spravovat vlo¾ené zprávy ?";
$f_lang['admin_gestion_censure'] = "&nbsp;&nbsp;&nbsp;&nbsp;\"&nbsp;&nbsp;&nbsp;&nbsp;spravovat zakázaná slova ?";
$f_lang['admin_gestion_smileys'] = "&nbsp;&nbsp;&nbsp;&nbsp;\"&nbsp;&nbsp;&nbsp;&nbsp;spravovat smajlíky ?";
$f_lang['admin_gestion_admin'] = "&nbsp;&nbsp;&nbsp;&nbsp;\"&nbsp;&nbsp;&nbsp;&nbsp;spravovat úèty dal¹ích administrátorù ?";
$f_lang['erreur_name'] = "Zadejte prosím u¾ivatelské jméno";
$f_lang['erreur_passe'] = "Zadejte prosím heslo";
$f_lang['erreur_email'] = "Zadejte prosím e-mail";
$f_lang['ok_aj_admin'] = "Díky, úèet byl úspì¹nì vytvoøen";
$f_lang['ok_modif_admin'] = "Díky, úèet byl aktualizován";
$f_lang['erreur_aj_admin'] = "CHYBA\\nToto u¾ivatelské jméno ji¾ existuje";
$f_lang['revenir'] = "Zpìt na pøedchozí stránku";

/* gestion des admins */
$f_lang['gest_admin'] = "Správa administrátorù";
$f_lang['sup_admin'] = "odebrat";
$f_lang['login_admin'] = "pøihla¹ovací jméno";
...
$f_lang['erreur_auth'] = "Chyba pøi pøihlá¹ení";
$f_lang['erreur_droits'] = "Nemáte odpovídající práva pro pøístup na tuto stránku.";

/* affichage du livre d'or */
$f_lang['note_moyenne'] = "Prùmìrná známka udìlená náv¹tìvníky tìmto stránkám :";
$f_lang['title_guestbook'] = "Na¹e náv¹tìvní kniha";
...
$f_lang['note_visiteur'] = "Va¹e hodnocení :";
$f_lang['message_visiteur'] = "Va¹e zpráva :";
$f_lang['ajouter_message_visiteur'] = "Vlo¾it tuto zprávu";
$f_lang['erreur_add_nom'] = "Zadejte prosím Va¹e jméno";
$f_lang['erreur_add_message'] = "Zadejte prosím Va¹i zprávu";
$f_lang['erreur_mail'] = "Va¹e e-mailová adresa není správná";
$f_lang['messages'] = "Zprávy";
$f_lang['messages_a'] = "a¾";
$f_lang['page'] = "Stránka";
...
$f_lang['go_home'] = "Nav¹tivte stránky";
$f_lang['precedente'] = "&lt;&lt; pøedchozí";
$f_lang['suivante'] = "dal¹í &gt;&gt;";
$f_lang['no_message'] = "Nejsou tu ¾ádné zprávy.";
$f_lang['no_ip'] = "POZOR\\nVa¹e IP adresa je zakázána, nemáte právo vkládat zprávy do této náv¹tìvní knihy.";
$f_lang['ok_post'] = "Díky !  Va¹e zpráva byla úspì¹nì vlo¾ena.";
$f_lang['time_erreur'] = "POZOR\\nVa¹e zpráva nemohla být vlo¾ena, vkládal/a jste zprávu pøed chvilkou.";
...
$f_lang['mail_message'] = "Dobrý den,\n\ndo Va¹í náv¹tìvní knihy byla vlo¾ena nová zpráva ";
...
$f_lang['note_modif'] = "Hodnocení Va¹ich stránek";
$f_lang['ville_pays_modif'] = "Mìsto / Zemì";
$f_lang['date_modif'] = "Datum vlo¾ení";
$f_lang['ip_modif'] = "IP adresa";
$f_lang['ok_modif_mess'] = "Díky, zmìny byly ulo¾eny";
...
$f_lang['erreur_connexion'] = "Va¹e pøihla¹ovací údaje nejsou správné";
$f_lang['manque login'] = "Zadejte prosím Va¹e pøihla¹ovací jméno";
$f_lang['manque pass'] = "Zadejte prosím Va¹e heslo";
$f_lang['end session'] = "Va¹e relace byla ukonèena";

/* add version 3.11 */
$f_lang['addSignature'] = "Vlo¾it novou zprávu";
$f_lang['seeMessages'] = "Èíst zprávy";
$f_lang['addMessageBlocAdd'] = "Pøidat zprávu do náv¹tìvní knihy";

/* add version 3.2 */
$f_lang['version'] = "Verze";
$f_lang['new_version_dispo'] = "Je k dispozici nová verze Náv¹tìvní knihy";
$f_lang['version_courrante'] = "Stávající verze skriptù";
$f_lang['info_version'] = "Informace o Va¹í verzi";
$f_lang['version_txt_ok'] = "Va¹e verze je ".$alex_livre_version.",<br>tato verze je nejnovìj¹í, netøeba aktualizovat.";
...
$f_lang['version_txt_update'] = "Va¹e verze je ".$alex_livre_version.", <b>k dispozici je novìj¹í verze</b>";
$f_lang['version_down'] = "Stáhnout novou verzi";
$f_lang['help_update'] = "Pomoc pøi aktualizaci";
$f_lang['spam'] = "USER AGENT Va¹eho prohlí¾eèe nebyl identifikován, vypadá to, jako by se nìjaký robot pokou¹el automatizovanì vlo¾it zprávu. Pokud tomu tak není, zkuste to prosím z jiného prohlí¾eèe.";
$f_lang['avis_spammeurs'] = "Poznámka pro spammery";
$f_lang['txt_spammeurs'] = "<b>Tato náv¹tìvní kniha je chránìna pøed spammery</b>, E-mailové a www adresy jsou ve zdrojovém kódu stránek za¹ifrovány, proto je naprostosto zbyteèné vkládat komerèní odkazy, nebudou vidìt ve vyhledávaèích (navíc va¹e zpráva bude stejnì vymazána...)";
$f_lang['fermer'] = "Zavøít toto okno";
$f_lang['valider_messages'] = "Chcete nejprve prohlédnout vlo¾ené zprávy pøed jejich zveøejnìním ?";
...
$f_lang['ok_post_valid'] = "Díky ! Va¹e zpráva byla úspì¹nì vlo¾ena, bude zveøejnìna, jakmile ji webnmaster schválí.";
$f_lang['see_skin'] = "Zobrazit náv¹tìvní knihu v tomto vzhledu";
$f_lang['maxi_car'] = "Maximálnì povolený poèet znakù ve zprávì (0 = bez omezení)";
$f_lang['il_reste'] = "Do Va¹í zprávy mù¾ete napsat je¹tì";
...
$f_lang['add_code_securite'] = "Chcete, aby u¾ivatel musel pøed odesláním zprávy zapsat bezpeènostní kód?";
$f_lang['t_chem_dossier_fonts'] = "Kompletní cesta (URL) ke slo¾ce s fonty";
$f_lang['t_color_txt_code'] = "Hexadecimální kód barvy textu";
$f_lang['t_color_background_code'] = "Hexadecimální kód barvy pozadí";
$f_lang['veuillez_taper_code'] = "Opi¹tì prosím tento bezpeènostní kód do políèka vpravo";
$f_lang['a_quoi_ca_sert'] = "A proèpak?";
$f_lang['why_code'] = "Proè \"bezpeènostní kód\" ?";
$f_lang['txt_why_code'] = "Umo¾òuje zkontrolovat, zda zpráva byla vlo¾ena skuteèným ¾ivým náv¹tìvníkem a ne automaticky pracujícím softwarem.<br><br><b>Komerèní zprávy a spamm jsou zde zakázány!</b>";
...
$f_lang['text_reponse_auto'] = "<b>Zde mù¾ete zadat text automatické odpovìdi</b> odesílané náv¹tìvníkovi, jen¾ vlo¾í zprávu do Va¹í náv¹tìvní knihy. Tato zpráva bude odeslána, pokud tuto funkci aktuvujete v parametrech.<br><br>Ka¾dý jazyk má svou vlastní odpovìï a kód [PSEUDO] bude nahrazen jménem nebo pøezdívkou náv¹tìvníka, která zprávu vlo¾il.";
...
$f_lang['txt_remerciement'] = "Dobrý den, [PSEUDO],\n\ndìkujeme za zprávu v na¹í náv¹tìvní knize!";
$f_lang['ok_save_msg_rem'] = "Díky, automatická odpovìï byla ulo¾ena.";
$f_lang['envoyer_remerciement'] = "Chcete, aby bylo automaticky odesláno podìkování?";
$f_lang['remerciement'] = "Díky";
$f_lang['titre_guestbook'] = "Titulek náv¹tìvní knihy";
$f_lang['text_titre_guestbook'] = "<b>Mù¾ete zmìnit titulek náv¹tìvní knihy</b> a napsat svùj vlastní pro ka¾dý z jazykù.";
$f_lang['titre'] = "Titulek";
$f_lang['parametrage'] = "Nastavení";
$f_lang['ok_save_titre'] = "Díky, titulek byl ulo¾en.";
...
$f_lang['votre_reponse'] = "Va¹e odpovìï";
$f_lang['ok_reponse_mess'] = "Díky, Va¹e odpovìï byla ulo¾ena";
...
$f_lang['plus_smileys'] = "Uka¾ dal¹í smajlíky";
$f_lang['liste_all_smilies'] = "Seznam v¹ech smajlíkù";
$f_lang['boite_java'] = "Javascript Box";
$f_lang['text_boite_java'] = "<b>Tato funkce Vám umo¾òuje zobrazit poslední zprávy vlo¾ené do Va¹í náv¹tìvní knihy</b> na stránce dle Va¹í volby.";
$f_lang['parametrage_modele'] = "Nastavení masky";
$f_lang['ok_save_boite'] = "Díky, Va¹e nastavení bylo ulo¾eno";
...
$f_lang['url_dossier_livre_boite'] = "Doplòte adresu URL ke slo¾ce s náv¹tìvní knihou";
$f_lang['url_livre_boite'] = "Doplòte adresu URL úvodní stránky náv¹tìvní knihy";
...
$f_lang['erreur_par_boite'] = "Chyba v konfiguraci, nemohu ve va¹í masce najít sekci [BOUCLE] ... [/BOUCLE].";
...
$f_lang['optimisation_txt'] = "<b>Po zápisech a mazání zùstalo v tabulkách databáze nevyu¾ité místo.</b> To není vhodné z pohledu rychlosti odezvy a výkonu databáze a tím i Va¹ich stránek. Tato funkce umo¾òuje øe¹it problém optimalizací tabulek.";
$f_lang['liste_tables'] = "Seznam tabulek ve Va¹í databázi";
$f_lang['lancer_optimisation'] = "Spou¹tím optimalizaci";
$f_lang['tables'] = "TABULKY";
$f_lang['pertes'] = "NAVÍC";
$f_lang['octets'] = "bytù";
$f_lang['ok_optimise'] = "Díky, optimalizace tabulek byla provedena";
$f_lang['txt_sauvegarde'] = "<b>Pokud chcete archivovat zprávy del¹í èas, dùraznì doporuèujeme pravidelné zálohování dat.</b> Problém s hardwarem problém mù¾e zlikvidovat v¹echna Va¹e data. Záloha mù¾e být také u¾iteèná pøi pøechodu na jiný server.";
$f_lang['lancer_sauvegarde'] = "Spustit zálohování";
$f_lang['lancer_restauration'] = "Spustit obnovu";
$f_lang['txt_restauration'] = "<b>Pokud máte k dispozici zálohu, mù¾ete kompletnì obnovit data Va¹í náv¹tìvní knihy</b> Prostì jenom na Va¹em disku vyberte odpovídající soubor se zálohou .<br><br><b><u>POZOR</u></b>, pokud je tento soubor pøíli¹ veliký (nìkolik megabytù), mù¾e pøi obnovì dojít k problému díky nastavení Va¹eho serveru (èasový limit bìhu skriptu nebo maximálnì povolená velikost nahrávaného souboru).";
$f_lang['select_file'] = "Vyberte soubor se zálohou na Va¹em disku (.ZIP nebo .SQL)";
$f_lang['confirm_restauration'] = "Potvrzujete spu¹tìní obnovy dat ? Aktuální data budou smazána!";
$f_lang['select_file_restau'] = "Vyberte prosím soubor na Va¹em disku";
$f_lang['erreur_ext_restau'] = "Vybraný soubor nemá pøíponu .ZIP nebo .SQL, obnova dat nemù¾e být spu¹tìna.";
$f_lang['conseil_zip'] = "(Rozbalte ZIP soubor na Vá¹ pevný disk k získání souboru SQL)";
$f_lang['erreur_ext_zip'] = "Extension PHP_ZIP není na serveru dostupná, obnova dat ze ZIP souboru není mo¾ná. Vyberte prosím .SQL soubor na Va¹em disku".$f_lang['conseil_zip'].".";
$f_lang['erreur_zip'] = "Chyba pøi ètení Va¹eho ZIP archivu, nelze spustit obnovu dat.  Zkuste to prostøednictvím .SQL souboru ".$f_lang['conseil_zip'].".";
$f_lang['erreur_read_sql'] = "Vybraný soubor SQL neobsahuje odpovídající pøíkazy pro obnovu dat náv¹tìvní knihy \"@lex Guestbook\".  Obnova nemù¾e být spu¹tìna.";
$f_lang['restauration_terminee'] = "Díky ! Obnova dat byla úspì¹nì provedena !";
